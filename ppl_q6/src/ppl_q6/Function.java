...
public class Function {
     ...
     * @param t couple having happiness less tahn t will break up 
     */
    public void assignNew(ArrayList<Couple> coupleArray, ArrayList<Boy> boyArray, ArrayList<Girl> giftArray, int t) {
        ...
        Boy b;
        for(i=0;i<n;i++){
            if(coupleArray.get(i).happiness < t*20 ){
                ind = -1;
